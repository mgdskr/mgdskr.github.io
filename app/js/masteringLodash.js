...
// skillsNC = _.flattenDeep(skillsNC);
// skillsNC = _.uniq(skillsNC);
// skillsNC = _.sortBy(skillsNC);
// console.log('1 Skills NO chaining: ', skillsNC);

// --------------2---------------
let sortedByFriendsNum = _
.chain(data)
.sortBy('friends.length')
.map('name')
.value();

console.log('2 Names sorted by friends number (ASC)',sortedByFriendsNum);
...
let friends = _
	...
	.uniq()
	.value();
console.log('3 Uniq friend\'s names: ', friends);
